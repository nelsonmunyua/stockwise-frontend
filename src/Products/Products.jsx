...
function Products() {
  ...
  const editProduct = async () => {
    try {
      await axios.put(`http://localhost:8000/products/${selectedProduct.id}`, formData);
      getAllProducts();
    ...
    return (
      <>
        ...
        <button 
          ...
          onClick={() => deleteProductConfirm(rowData)}
        >
      ...
      <div className="card">
        ...
        <div className="card-body">
          ...
          >
            ...
            <Column field="quantity" header="Stock" body={stockTemplate} sortable></Column>
            <Column field="category_name" header="Category" body={categoryTemplate} sortable></Column>
      ...
      <Dialog 
        ...
        footer={
          <div>
            ...
            <button className="btn btn-success ms-2" onClick={addProduct}>
              Add
            </button>
          </div>
        }
      ...
      <Dialog 
        ...
        footer={
          <div>
            ...
            <button className="btn btn-success ms-2" onClick={editProduct}>
              Update
            </button>
          </div>
        }
